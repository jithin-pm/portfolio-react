...
import profile from '../uploads/Pics.jpg'
import '../styles/home.css'
import resume from '../uploads/jithinpm-resume (2).pdf'
  ...
  return (
    <>
      ...
      <div className="container" id='hom' >
        ...
        <div className='name'>
          <h2 className='hi'>I'M <span style={{color:"yellow", fontWeight:"bold"}} >JITHIN PM</span></h2>
          <h1>Full Stack Developer</h1>
          <p>Hi there! I'm Jithin pm, a passionate and versatile full-stack developer with a keen eye for <br />
